            ...
            for intronNeg_start in splice_recordN:
                ...
                if distance3_range >= -D:
                    if distance3_range <= D:
                        ...
                        #intronNeg_start represent 3'SS on negative DNA strand oriantation, so do negation for distance3_range in version 1.7 (for proper plotting)
            ...
            for intronNeg_end in splice_recordN2:
                ...
                if distance4_range >= -D:
                    if distance4_range <= D:
                        ...
                        #intronNeg_end represent 5'SS on negative DNA strand oriantation, so do negation for distance4_range in version 1.7 (for proper plotting)
